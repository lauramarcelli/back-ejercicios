...
esta información.
Indicaciones:
1. Crea un archivo llamado app.js.2. Escribe un programa que imprima en la consola la plataforma y el
directorio actual.
...
console.log(`La plataforma del sistema operativo es: ${process.platform} Estas trabajando en el directorio: ${process.cwd()}`);